...
<body>
  ...
  <!-- 추가된 부분 -->
	...
	<table id="ta1" radius="6" rborder="#999999" rbgcolor="#F8F8F8">
		<tr>
			<th>아 이 디</th>
			<td class="sendPostTd"><input type="text" name="user" required="required" maxlength="20" placeholder="회원 아이디를 입력해주세요"/></td>			
		</tr>
		<tr>
			<th>제     목</th>
	...
	<div class="sendPostBtnDiv">
		<input type="submit" class="sendPostBtn" value="쪽지 보내기" />&nbsp;
