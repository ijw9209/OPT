...
<script type="text/javascript">
			...
			$
					.ajax({
						...
						success : function(data) {
							findId = $.trim(data);
							console.log(findId);
							var message = "<b>고객님의 아이디입니다.</b> <br/><input type='button' class='btn checkBtn' value='확인' onclick='insertId(\""
									+ findId + "\")'>";
							id.html(message);
						},
						error : function() {
	...
	function insertId(id) {
		...
		opener.document.getElementById("pwCheck").focus();
		close();
	}
</script>
</head>
<body>
	<section class="content">
		<h1 class="pageHead">아이디 찾기</h1>
		<ul>
			<li><input class="findBox" type="text"
				id="opt_email" name="opt_email" size="25"> <input
				class="findBtn" type="button" value="이메일 인증" onclick="emailChk()"><br>
				<span id="emailSpan"></span></li>
			<li><input class="findBox" type="text"
				id="emailConfirm" size="25"> <input class="findBtn"
				type="button" value="확   인" onclick="emailCon()"><br> <span
