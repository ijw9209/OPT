...
<body>
	<footer class="foot_area">
		<div class="content_area">
			<div class="foot_menu">
				<ul class="menu_left" style="font-family: 'Nanum Gothic', sans-serif;">	
					<li><a class="menu_foot" href="#">개인정보처리(취급)방침 </a></li>
					<li><a class="menu_foot" href="#">이메일무단수집거부 </a></li>
					<li><a class="menu_foot" href="#">이용약관 </a></li>
					<li><a class="menu_foot" href="#">고객센터 </a></li>
				</ul>
			</div>
			<div class="foot_menu_bottom">
				<div class="foot_info">
					<p>서울특별시 강남구 테헤란로 <em>14</em> 하나금융그룹 강남사옥 남도빌딩 <em>2F, 3F, 4F, 5F</em></p>
					<p>대표전화 <em>1588-9988</em> 통신판매업신고 <em>2016</em>-서울강남-<em>03054</em> 사업자등록번호 <em>126-81-38772</em></p>
				...
				<div class="sns_list">
					...
					<a href="https://www.naver.com" title="opt_instargram">
